...
There were `r left_join(odk, vl_dat, by = "ptid") %>% filter(confgend == 2, testtype %in% c("VL", "VL_DBS"), approved == "approved") %>% nrow()` females with approved Viral Load Results from plasma or DBS in the ODK dataset.
